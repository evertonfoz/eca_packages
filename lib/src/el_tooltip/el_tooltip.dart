...
class ElTooltip extends StatefulWidget {
  const ElTooltip({
    ...
    this.timeout = 0,
    this.bottomContent,
    this.bottomIconLeftButton,
    this.bottomIconRightButton,
    this.bottonIconLeftOnTap,
    this.bottonIconRightOnTap,
    this.bottomWidth,
    super.key,
  });
  final Widget? bottomContent;
  final IconData? bottomIconLeftButton;
  final IconData? bottomIconRightButton;
  final VoidCallback? bottonIconLeftOnTap;
  final VoidCallback? bottonIconRightOnTap;
            ...
            Positioned(
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    visible: widget.bottomContent != null,
                    child: SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              Visibility(
                                visible: widget.bottomIconLeftButton != null,
                                child: IconButton(
                                  color: Colors.green,
                                  icon: FaIcon(widget.bottomIconLeftButton!),
                                  iconSize: 36,
                                  onPressed: () {
                                    _hideOverlay();
                                    widget.bottonIconLeftOnTap!;
                                  },
                                ),
                              ),
                              Visibility(
                                visible: widget.bottomIconRightButton != null,
                                child: IconButton(
                                  color: Colors.red,
                                  icon: FaIcon(widget.bottomIconRightButton!),
                                  iconSize: 36,
                                  onPressed: () {
                                    _hideOverlay();
                                    widget.bottomIconRightButton!;
                                  },
                                ),
                              ),
                            ],
